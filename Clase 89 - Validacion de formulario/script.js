    ...
    $inputName.addEventListener("blur", () => {
        switch (true) {
            ...
            case !regExAlpha.test($inputName.value):
                ...
                $inputName.classList.add("is-invalid");
                break;
            default: /* Defaul saca los errores */
                $inputName.classList.remove("is-invalid"); /* saca clase is invalid */
                $inputName.classList.add("is-valid"); /* agrega la clase is valid */
                $nameErrors.innerHTML = ""; /* Borra ek mensaje de arror del span */
                break;
        }
    })
